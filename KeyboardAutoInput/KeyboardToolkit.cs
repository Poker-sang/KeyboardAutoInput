...
{
    internal static class KeyboardToolkit
    {
        ...
        public static class Keyboard
        {
            ...
            public static void Press(Key key) => SendKeyboardInput(key, true);

            /// <summary>
            /// Releases a key.
            /// </summary>
            /// <param name="key">The key to release.</param>
            public static void Release(Key key) => SendKeyboardInput(key, false);
            ...
            private static void SendKeyboardInput(Key key, bool press)
            {
                ...
                var ki = new NativeMethods.INPUT { type = NativeMethods.InputKeyboard };
